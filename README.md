...
This repository contains a deployable AI hallucination-recognition, confidence-collapse, release-control, ECL-finality, and Monti topological-memory certificate service.
...
- HTTP API service with health/version/schema/evaluate/batch/release/resolve/monti endpoints,
...
Deployable v1 for evaluation, gating, audit certificates, regression testing, ECL finality sealing, Monti temporal memory diagnostics, and integration into AI applications. It is not a standalone truth oracle and not a substitute for domain validation.
